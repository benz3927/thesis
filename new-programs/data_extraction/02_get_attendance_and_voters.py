...
attendees_csv_location = "../data/new-processed/Attendees/"
voters_csv_location = "../data/new-processed/Voters/"
#=========================================================
...
for i in np.arange(0,len(html_files)):
    with open(html_files[i]) as fhandler:
        print(f"Working on: {html_files[i]}...")
        number_files = 0
        ...
        # first_page = re.findall(r"Meeting of the(.+?) Transcript", pure_text)
        first_page = re.findall(r"Meeting of the (.+?)(?:\n|A meeting|$)", pure_text)
# =============================================================================
#         if len(first_page) ==0:
...
# =============================================================================
       ...
       # pattern_to_remove = r'\b(?:{})\b',format('|'.join(non_names_please_delete))
        df_names['Clean Names'] = df_names['Name'].str.replace(pattern_to_remove[1], '').str.replace(r'\d+','')
        ...
        df_names.to_csv(attendees_csv_location + html_files[number_files][13:21] + "_att.csv")
        print(f"csv made??")
...
# =============================================================================
        ...
        df_voters['Voters'] = df_voters['Voters'].str.replace(voting_pattern_to_remove, '').str.replace(r'\d+','')
        ...
        df_voters.to_csv(voters_csv_location + html_files[number_files][13:21] + "_voters.csv")
