...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 14 18:23:54 2023
...
# HTML directory
htmls_road = '/if/research_ifs/fomc_transcript/conferencecall/htmls/'
htmls_ls = r'/if/research_ifs/fomc_transcript/conferencecall/htmls/*.html'
...
for i in np.arange(0,len(html_files)):
    with open(html_files[i]) as fhandler:
        number_files = i
        date = html_files[number_files][58:66]
        ...
        df_transcript['date'] = date
        df_transcript.to_csv("/if/research_ifs/fomc_transcript/data/processed/ConferenceCall/" + html_files[number_files][58:66] + "_cc.csv" )
