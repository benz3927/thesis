...
for i in np.arange(0,len(att_files)):
    with open(att_files[i]) as fhandler:
        ...
        csv = csv[csv['Greeting'].isin(['Ms']) == True]
        csv = csv.reset_index()
...
df['bucket_1_female'] = bucket1_total
df['bucket_2_female'] = bucket2_total
df['bucket_3_female'] = bucket3_total
df['bucket_4_female'] = bucket4_total

df_long['date'] = dates
df_long['bucket_1_female'] = bucket1_total_per_person
df_long['bucket_2_female'] = bucket2_total_per_person
df_long['bucket_3_female'] = bucket3_total_per_person
df_long['bucket_4_female'] = bucket4_total_per_person




df['total_female'] = df['bucket_1_female'] + df['bucket_2_female'] + df['bucket_3_female'] + df['bucket_4_female']

df['bucket1_perc_female'] = df['bucket_1_female'] / df['total_female']

df['bucket2_perc_female'] = df['bucket_2_female'] / df['total_female']

df['bucket3_perc_female'] = df['bucket_3_female'] / df['total_female']

df['bucket4_perc_female'] = df['bucket_4_female'] / df['total_female']
...
df.to_csv('fomc_transcript/data/processed/sets/buckets_female.csv')
df_long.to_csv('fomc_transcript/data/processed/sets/buckets_dummy_female.csv')
